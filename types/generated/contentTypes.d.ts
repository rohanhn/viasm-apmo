...
export interface ApiCountryRankingCountryRanking
  extends Struct.CollectionTypeSchema {
  collectionName: 'country_rankings';
  info: {
    displayName: 'Country Ranking';
    pluralName: 'country-rankings';
    singularName: 'country-ranking';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    bronze_cut: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contestants_num: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    honorable_mentions: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    silver_cut: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProblemSolutionProblemSolution
  extends Struct.CollectionTypeSchema {
  collectionName: 'problem_solutions';
  info: {
    displayName: 'Problem solution';
    pluralName: 'problem-solutions';
    singularName: 'problem-solution';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::problem-solution.problem-solution'
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID &
      Schema.Attribute.Required &
...
export interface ApiProblemStatementProblemStatement
  extends Struct.CollectionTypeSchema {
  collectionName: 'problem_statements';
  info: {
    displayName: 'Problem statement';
    pluralName: 'problem-statements';
    singularName: 'problem-statement';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::problem-statement.problem-statement'
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID &
      Schema.Attribute.Required &
...
export interface ApiTimelineTimeline extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    MC: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    num_contestants: Schema.Attribute.BigInteger &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    num_countries: Schema.Attribute.BigInteger &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
